...
function homepage() {
  ...
  navBarDiv.setAttribute(
    "style",
    "gap:20px;height:100px;padding:20px;background-color:#193A07;position: fixed;top: 0;width: 100%;height:auto;"
  );

  navBarDiv.setAttribute(
    "class",
    "navBarDiv align-items-center justify-content-center "
  );

  let titleHomeDiv = document.createElement("div");
  titleHomeDiv.setAttribute("style", "height:auto;width:100%;");
  mainDiv.appendChild(titleHomeDiv);

  let dictionaryName = document.createElement("h2");
  dictionaryName.textContent = "My-Dictionary";
  dictionaryName.setAttribute(
    "style",
    "color:white;font-size:auto;font-weight:1000"
  );
  ...
  navBarDiv.appendChild(titleHomeDiv);
  titleHomeDiv.appendChild(dictionaryName);
